                ...
                <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href='mailto:delazeri@delazeri.com.br' className="small text-muted">
                        delazeri@delazeri.com.br
                      </a>
                    </td>
                    <td>
                      Loja de roupas
                    ...
                    <td>
                      <div className="clearfix">
                        ...
                        <div className="float-right">
                          <small className="text-muted">Jun 11, 2015 - Jul 10, 2015 (previsão)</small>
                        </div>
                      </div>
